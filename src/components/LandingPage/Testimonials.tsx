...
const Testimonials = () => {
    return(
        <section className="w-[90%] relative flex flex-col items-center mt-[5rem] mx-[1rem] lg:px-[5rem] lg:w-[100%] lg">
            <img className="absolute top-0 right-[10%] w-[6rem] rotate-30 lg:w-[10rem]" src={Mascots} />
            ...
            <div className="lg:flex lg:w-[100%] lg:items-center lg:justify-between lg:mt-[3rem]">
                <TestimonialsCard
