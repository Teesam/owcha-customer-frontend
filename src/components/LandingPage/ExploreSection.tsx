    ...
    return (
        <section className="mt-[4rem] flex flex-col items-center text-[#fff] lg:px-[5rem]">
            ...
            <div className="flex flex-col lg:flex-row lg:flex-wrap lg:justify-between items-center">
                <div className="bg-[#EC6640] mb-[2rem] w-[90%] lg:w-[60%] lg:h-[25rem]  rounded-2xl pl-[2rem] pr-[2rem] pt-[3rem] pb-[3rem] mt-[2rem]">
                ...
                <div className="bg-[linear-gradient(135deg,#7C1EDA99_10%,#7C1EDA)] mb-[2rem] w-[90%] lg:w-[35%] lg:h-[25rem]  rounded-2xl pl-[2rem] pr-[2rem] pt-[3rem] pb-[3rem] mt-[2rem]">
                ...
                <div className="bg-[linear-gradient(135deg,#00A8F099_10%,#00A8F0)] mb-[2rem] w-[90%] lg:w-[35%] lg:h-[25rem]  rounded-2xl pl-[2rem] pr-[2rem] pt-[3rem] pb-[3rem] mt-[2rem]">
                ...
                <div className="bg-[linear-gradient(135deg,#50CA1CCC_10%,#50CA1C)] mb-[2rem] w-[90%] lg:w-[60%] lg:h-[25rem] rounded-2xl pl-[2rem] pr-[2rem] pt-[3rem] pb-[2rem] mt-[2rem]">
                    <img src={ExploreIcon} className="w-[4rem]" />
