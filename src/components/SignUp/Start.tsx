...
const Start = ({updateActive}: {updateActive: (active: string) => void}) => {
    ...
    return(
        <div className="flex justify-center px-[1rem] min-h-[100vh] lg:w-[30vw]">
            <div className="flex flex-col items-center justify-center min-h-[100%] w-[100%]">
                ...
                <h2 className="font-bold text-[1.5rem] mt-[1rem] text-center lg:text-[1rem]">How would you like to use Owcha?</h2>
                <button className="cursor-pointer w-[100%]" onClick={() => setCurrentMenu("attendee")}>
                    <div className={`${currentMenu === "attendee" ? "w-[100%] flex px-[1rem] py-[2rem] rounded-lg border-2 border-[#7C1EDA] mt-[1rem]" 
                        ...
                        <div className="flex flex-col items-start ml-[1rem]">
                            <h4 className="font-bold text-[1rem] lg:text-[.8rem]">Attendee</h4>
                            <p className="text-[#475467] text-start mt-[.2rem] lg:text-[.7rem]">Discover events and meet people</p>
                        </div>
                    </div>
                </button>
                <button className="cursor-pointer w-[100%]"  onClick={() => setCurrentMenu("vendor")}>
                    <div className={`${currentMenu === "vendor" ? "w-[100%] flex px-[1rem] py-[2rem] rounded-lg border-2 border-[#7C1EDA] mt-[1rem]" 
                        ...
                        <div className="flex flex-col items-start ml-[1rem]">
                            <h4 className="font-bold text-[1rem] lg:text-[.8rem]">Event Organizer</h4>
                            <p className="text-[#475467] text-start mt-[.2rem] lg:text-[.7rem]">Create events and build community</p>
                        </div>
                    </div>
                </button>

                <button 
                    className="cursor-pointer mt-[2rem] w-[100%] bg-[#7C1EDA] py-[1rem] rounded-lg text-white" 
